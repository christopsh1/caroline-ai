...
if (!key) throw new Error('CAROLINE_RUNTIME_KEY is required')
...
if (!status.ok || statusBody?.ok !== true) {
  throw new Error(`status failed: ${status.status} ${JSON.stringify(statusBody)}`)
}
