...
APPROVED_COLUMNS = {
    ...
    'brain_turn_metrics': ('id', 'conversation_key', 'query_hash', 'interaction_mode', 'caller_phone', 'model_requested', 'model_used', 'fallback_used', 'upstream_headers_ms', 'tool_count', 'status', 'error_class', 'created_at', 'first_token_ms', 'total_proxy_ms', 'timed_out', 'degraded'),
